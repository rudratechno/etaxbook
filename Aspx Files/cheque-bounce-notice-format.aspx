...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="services">
        <div class="container">
            ...
            <br>
            <h3 style="text-align: center;">How to Issue Cheque Bounce Notice</h3>
            <br>
            <p class="w3layouts_para1">
            ...
            <br />
            <h3 style="text-align: center;">When Cheque Bounce Notice Can Be Issued</h3>
            <br>
            <p class="w3layouts_para1">
            ...
            <h3 style="text-align: center;">Initiating Legal Action for Cheque Bounce</h3>
            <br>
            <p class="w3layouts_para1">
            ...
            <h3 style="text-align: center;">Section 138 of Negotiable Instruments Act</h3>
            <br>
            <p class="w3layouts_para1">
                ...
                <br />
                3. The drawer of such cheque fails to make the payment of the said amount of money to the payee or, as the case may be, to the holder in due course of the cheque, within fifteen days of the receipt of the said notice. Explanation.-For the purposes of this section, “debt or other liability” means a legally enforceable debt or other liability.
                <br />
                <br />
            ...
            <h3 style="text-align: center;">Section 141 of Negotiable Instruments Act – For Companies</h3>
            <br>
            <p class="w3layouts_para1">
            ...
            <%--            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <img src="images/Sample-Partnership-Agreement.jpg" class="img-thumbnail img-responsive" style="width: 100%;" />
                </div>
            </div>--%>
            <br>
            <br />
