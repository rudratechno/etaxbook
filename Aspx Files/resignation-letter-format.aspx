...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="services">
        <div class="container">
            ...
            <br>
            <h3 style="text-align: center;">How to Submit Resignation Letter</h3>
            <br>
            <p class="w3layouts_para1">
            ...
            <br />
            <h3 style="text-align: center;">How to Create Resignation Letter</h3>
            <br>
            <p class="w3layouts_para1">
            ...
            <br>
            <h3 style="text-align: center;">Points to Remember</h3>
            <br>
            <p class="w3layouts_para1">
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <img src="images/Sample-Resignation-Letter.jpg" class="img-thumbnail img-responsive" style="width: 100%;" />
                </div>
            </div>
            <br>
            <br />
